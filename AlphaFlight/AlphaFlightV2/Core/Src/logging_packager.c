...
uint8_t* LOGGING_PACKER_BY_MODE(uint16_t MODE){
	...
	void snapshot_t1v0_general(){
		t1v0_general_data.timestamp = HAL_GetTick();
		...
		t1v0_general_data.gps_heading = gps_nav_pvt.heading;
		t1v0_general_data.gps_height = gps_nav_pvt.height;
		t1v0_general_data.gps_lat = gps_nav_pvt.lat;
		t1v0_general_data.gps_lon = gps_nav_pvt.lon;
		t1v0_general_data.gps_sats = gps_nav_pvt.numSV;
		t1v0_general_data.gps_speed = gps_nav_pvt.gSpeed;
